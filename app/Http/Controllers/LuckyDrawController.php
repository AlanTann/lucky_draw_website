...
class LuckyDrawController extends Controller
{
    public function drawWinner(Request $req)
    {
        ...
        if($winning_number) {
            ...
            if(!$user_id) {
                return View::make('admin', ['result' => 'This lucky number does not belong to any user.']);
            }
        }
        ...
        if($random == "no") {
            ...
            if($user_winner > 0) {
                return View::make('admin', ['result' => 'This user already had a prize']);
            }
            ...
            return View::make('admin', ['result' => 'Draw Successful']);
        }
        ...
        return View::make('admin', ['result' => 'Draw Random Successful']);
    }
